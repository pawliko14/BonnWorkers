...
$data = $_POST['d'];       		// <- limit, ile danych ma zostac pobranych 10 100 brak ...
$nazwisko_imie = $_POST['n'];

$connect = mysqli_connect("localhost", "root", "", "fatdb");

try
{
                $query = "select concat(werkuren.afdeling,'/', werkuren.AFDELINGSEQ, ' : ', werkuren.WERKBONNUMMER) as merged,
						   ...
						   where werkuren.WERKNEMER = '$nazwisko_imie' and werkuren.DATUM = '$data'
